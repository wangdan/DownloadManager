...
public final class DownloadProvider extends ContentProvider {
    ...
    static {
        sURIMatcher.addURI("tcldownloads", "my_downloads", MY_DOWNLOADS);
        sURIMatcher.addURI("tcldownloads", "my_downloads/#", MY_DOWNLOADS_ID);
        sURIMatcher.addURI("tcldownloads", "all_downloads", ALL_DOWNLOADS);
        sURIMatcher.addURI("tcldownloads", "all_downloads/#", ALL_DOWNLOADS_ID);
        sURIMatcher.addURI("tcldownloads",
        ...
        sURIMatcher.addURI("tcldownloads", "download", MY_DOWNLOADS);
        sURIMatcher.addURI("tcldownloads", "download/#", MY_DOWNLOADS_ID);
        sURIMatcher.addURI("tcldownloads",
    ...
    public Uri insert(final Uri uri, final ContentValues values) {
        ...
        if (dest != null) {
            ...
            if (dest == Downloads.Impl.DESTINATION_FILE_URI) {
                ...
                if (appOps.noteProxyOp(AppOpsManager.OPSTR_WRITE_EXTERNAL_STORAGE,
