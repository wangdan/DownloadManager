...
public class Constants {
    ...
    public static final String PROVIDER_PACKAGE_NAME = "com.tcl.downloader.downloads";
    ...
    public static final String STORAGE_AUTHORITY = "com.tcl.downloader.downloads.documents";
