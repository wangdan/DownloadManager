...
package org.aisen.downloader.downloads;
        ...
        public static int translateStatus(int status) {
            switch (status) {
                ...
                case Downloads.Impl.STATUS_RUNNING:
                    return org.aisen.downloader.DownloadManager.STATUS_RUNNING;

                case Downloads.Impl.STATUS_PAUSED_BY_APP:
                    return org.aisen.downloader.DownloadManager.STATUS_PAUSED;// wangdan, 2016-06-22, 修改暂停的定义

                case Downloads.Impl.STATUS_WAITING_TO_RETRY:
                case Downloads.Impl.STATUS_WAITING_FOR_NETWORK:
                case Downloads.Impl.STATUS_QUEUED_FOR_WIFI:
                    return org.aisen.downloader.DownloadManager.STATUS_WAITING;

                case Downloads.Impl.STATUS_SUCCESS:
                    return org.aisen.downloader.DownloadManager.STATUS_SUCCESSFUL;

                default:
                    assert Downloads.Impl.isStatusError(status);
                    return org.aisen.downloader.DownloadManager.STATUS_FAILED;
            }
        }
