...
import org.aisen.downloader.utils.FileUtils;
...
//            }
    ...
    static boolean isFilenameValid(Context context, File file, boolean allowInternal) {
        try {
            ...
            String[] volumes = new String[]{ "/storage/emulated/0", "/storage/sdcard0", "/storage/sdcard1", "/mnt/sdcard", "/mnt/sdcard2" };
            for (String volume : volumes) {
                if (file.getAbsolutePath().contains(volume)) {
                    return true;
                }
            }
