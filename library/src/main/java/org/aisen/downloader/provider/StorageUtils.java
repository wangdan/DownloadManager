...
import static org.aisen.downloader.downloads.Downloads.Impl.STATUS_INSUFFICIENT_SPACE_ERROR;
...
//            }
    ...
    public static IOException rethrowAsIOException(ErrnoException e) throws IOException {
