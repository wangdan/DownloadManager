...
public class AppsItemView extends ARecycleViewItemView<AppBean> implements View.OnClickListener, IDownloadObserver, org.aiwen.downloader.IDownloadObserver {
    ...
    public void onStatusChanged(org.aiwen.downloader.Request request) {
        ...
        // 正在下载
            ...
            Logger.v(org.aiwen.downloader.utils.Utils.getDownloaderTAG(request), "下载速度(%d), 平均速度(%d)", (int) request.getTrace().getSpeed(), (int) request.getTrace().getAverageSpeed());
        ...
        // 下载失败
            ...
            Logger.e(org.aiwen.downloader.utils.Utils.getDownloaderTAG(request), "下载失败(%d, %s, %s)", request.getDownloadInfo().getStatus(), request.getDownloadInfo().getError(), request.key);
