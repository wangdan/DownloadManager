...
public class DownloadManager {
    ...
    private DownloadManager(Context context, int maxThread) {
        ...
        this.mNotifier = new DownloadNotifier(context);
        this.mSystemFacade = new RealSystemFacade(context);
        this.mThreadManager = new ThreadManager(mContext, mDbHelper, mSystemFacade, mNotifier, maxThread);
    }
    ...
    public void enqueue(Request request) {
        mThreadManager.runAction(new EnqueueAction(request));
    }
    ...
    static class EnqueueAction extends Action {
